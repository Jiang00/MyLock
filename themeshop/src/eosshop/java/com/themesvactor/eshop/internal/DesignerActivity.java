...
public class DesignerActivity extends BaseActivity {
    ...
    private void setupDesigner(View v) {
        final ImageView iv = (ImageView) v.findViewById(R.id.shop_avatar);
        BitmapCache.setImageView(iv, themeContainer.icon);
        ((TextView) v.findViewById(R.id.shop_name)).setText(themeContainer.name);
    ...
    private void setupList() {
        ...
        if (themeContainer.pageThemes.themes.size() > 6) {
    ...
    private void setupToolbar() {
        ...
        title.setText(themeContainer.name);
