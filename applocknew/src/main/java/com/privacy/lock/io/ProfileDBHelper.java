...
public class ProfileDBHelper extends SQLiteOpenHelper {
    ...
    private static ProfileDBHelper helper;

    public static synchronized ProfileDBHelper singleton(Context context){
        if (helper == null){
            helper = new ProfileDBHelper(context.getApplicationContext(), NAME, null, VERSION);
    ...
    public ProfileDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
