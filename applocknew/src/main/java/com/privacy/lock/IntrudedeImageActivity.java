...
//                deleteIntruder();
        ...
        blockIcon.setBackgroundDrawable(icon==null?getResources().getDrawable(R.drawable.icon):icon);
        dateIcon.setBackgroundDrawable(icon==null?getResources().getDrawable(R.drawable.icon):icon);
        blockImage.setImage(url,0L, FileType.TYPE_PIC,true);
