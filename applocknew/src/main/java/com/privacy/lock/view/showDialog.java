...
import com.privacy.lib.view.MyWidgetContainer;
import com.privacy.lib.view.WidgetContainer;
import com.privacy.lock.R;
import com.privacy.lock.SetupPattern;
...
public class showDialog {
    ...
    public static void showPermission(final Context c) {
        final View alertDialogView = View.inflate(c, R.layout.show_permission, null);
        ...
        alertDialogView.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final View submitDialogView = View.inflate(v.getContext(), R.layout.show_permission_setting, null);
    ...
    public static void showResetPasswordDialog(final Context c) {
        final View alertDialogView = View.inflate(c, R.layout.show_lock_reset_password, null);
        final MyDialog d = new MyDialog(c, 0, 0, alertDialogView, R.style.dialog);
