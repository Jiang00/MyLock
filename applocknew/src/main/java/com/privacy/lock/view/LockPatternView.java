...
public class LockPatternView extends View {
    ...
    */
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        int innerNormal = attrs.getAttributeResourceValue(null, "inner", R.drawable.pattern_inner_normal);
        ...
        mPathPaint.setColor(getResources().getColor(R.color.pattern_line_color_normal));   // TODO this should be from the style
        ...
        dotSolid = hidePath ? dot : getResources().getDrawable(R.drawable.pattern_inner_right);
    ...
    public void setDisplayMode(DisplayMode displayMode) {
        ...
        if (displayMode == DisplayMode.Animate) {
            ...
            mPathPaint.setColor(hidePath ? 0x00000000 : getResources().getColor(R.color.pattern_line_color_normal));
        }
        invalidate();
    }
...
//        canvas.drawBitmap(innerCircle, mCircleMatrix, mPaint);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.privacy.lock.view.LockPatternView#onSaveInstanceState()}
         */
