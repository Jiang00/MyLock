...
//    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar();
        openFlag = SecurityMyPref.fetchIntruder();
        ...
        shutterFlag = SecurityPreference.isShutterSoundEnabled();
        ...
        intrude_open_fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (openFlag) {
                    openFlag = false;
                    SecurityMyPref.setFetchIntruder(openFlag);
        ...
        intrude_time_fl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showFrequencyDialog(SecurityIntruderSetting.this);
            }
        });
        setting_shutter_fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (shutterFlag) {
                    shutterFlag = false;
                    SecurityPreference.setShutterSoundEnabled(shutterFlag);
                    intruder_shutter.setImageResource(R.drawable.security_setting_not_check);
                } else {
                    shutterFlag = true;
                    SecurityPreference.setShutterSoundEnabled(shutterFlag);
    ...
    public void showFrequencyDialog(final Context c) {
        ...
        int idx = SecurityPreference.getIntruderSlot();
        if (idx == 0) {
        ...
        try {
            resetPattern.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    SecurityPreference.setIntruderSlot(0);
            ...
            resetPassword.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    SecurityPreference.setIntruderSlot(2);
            ...
            five_time.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    SecurityPreference.setIntruderSlot(1);
            ...
            five_time4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    SecurityPreference.setIntruderSlot(3);
            ...
            five_time5.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    SecurityPreference.setIntruderSlot(4);
