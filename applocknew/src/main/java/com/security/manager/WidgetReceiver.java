...
public class WidgetReceiver extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (TextUtils.equals("my.appwidget.action.wiget",intent.getAction())){
            ...
            Intent intent1 = new Intent(context, SecurityPatternActivity.class);
            ...
            ComponentName cn = new ComponentName(context.getApplicationContext(), SecurityPatternActivity.class);
...
//        for (int appID : appWidgetIds) {
        ...
        // 设置显示图片
        Intent startActivityIntent = new Intent(context, SecurityPatternActivity.class);
...
//        }
    ...
    public void onDisabled(Context context) {
        ...
        Intent stopUpdateIntent = new Intent(context, SecurityService.class);
