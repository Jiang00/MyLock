 ...
 */
public class SettingActivity extends ClientActivitySecurity {
...
//锁定设置
        ...
        int slot = sp.getInt(VacPref.PREF_BRIEF_SLOT, VacPref.PREF_DEFAULT);
        ...
        newLockFlag = sp.getBoolean(VacPref.LOCK_NEW, VacPref.LOCK_DEFAULT);
        if (newLockFlag) {
        ...
        noticeFlag = VacPref.getNotification();
        if (noticeFlag) {
        ...
        fingerprintFlag = VacPref.getFingerprintl();
        managerCompat = FingerprintManagerCompat.from(MyApp.getContext());
        keyguardManager = (KeyguardManager) MyApp.getContext().getSystemService(MyApp.getContext().KEYGUARD_SERVICE);
        ...
        batteryFlag = (Boolean) MyUtils.readData(this, BatteryConstants.CHARGE_SAVER_SWITCH, true);
        if (batteryFlag) {
...
//        widgetFlag = VacPref.getNotification();
        if (widgetFlag) {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.setting_frequency_fl:
                    showFrequencyDialog(SettingActivity.this);
                ...
                case R.id.setting_rebuild_fl:
                    Intent intent = new Intent(SettingActivity.this, VacSetPattern.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra("set", VacPref.isUseNormalPasswd() ? VacSetPattern.SET_GRAPH_PASSWD : VacSetPattern.SET_NORMAL_PASSWD);
                    startActivityForResult(intent, 220);
                    Tracker.sendEvent(Tracker.ACT_SETTING_MENU, Tracker.ACT_LEADER_SETTINGPASS, Tracker.ACT_LEADER_SETTINGPASS, 1L);
//                    showResetPasswordDialog(SettingActivity.this);
                    break;
                ...
                case R.id.setting_newlock_fl:
                    if (newLockFlag) {
                        newLockFlag = false;
                        sp.edit().putBoolean(VacPref.LOCK_NEW, false).apply();
                        setting_newlock_iv.setImageResource(R.drawable.security_setting_not_check);
                    } else {
                        newLockFlag = true;
                        sp.edit().putBoolean(VacPref.LOCK_NEW, true).apply();
                        setting_newlock_iv.setImageResource(R.drawable.security_setting_check);
                    }
                ...
                case R.id.setting_notice_fl:
                    if (noticeFlag) {
                        ...
                        stopService(new Intent(SettingActivity.this, VacNotificationService.class));
                        setting_notice_iv.setImageResource(R.drawable.security_setting_not_check);
                    } else {
                        noticeFlag = true;
                        VacPref.setNotification(true);
                        stopService(new Intent(SettingActivity.this, VacNotificationService.class));
                        startService(new Intent(SettingActivity.this, VacNotificationService.class));
                        setting_notice_iv.setImageResource(R.drawable.security_setting_check);
                    }
                ...
                case R.id.setting_fingerprint_fl:
                    ...
                    if (!managerCompat.hasEnrolledFingerprints()) { //判断设备是否已经注册过指纹
                        final View alert = View.inflate(SettingActivity.this, R.layout.security_fingerprint_alert, null);
                        final AlertDialog alertDialog = new AlertDialog.Builder(SettingActivity.this, R.style.dialog2).create();
...
//                        fingerprint.setScale(0.07f);//相对原大小的0.2倍
                ...
                case R.id.setting_battery_fl:
                    ...
                    if (batteryFlag) {
                        batteryFlag = false;
                        setting_battery_iv.setImageResource(R.drawable.security_setting_not_check);
                        MyUtils.writeData(SettingActivity.this, BatteryConstants.CHARGE_SAVER_SWITCH, false);
                    } else {
                        batteryFlag = true;
                        setting_battery_iv.setImageResource(R.drawable.security_setting_check);
                        MyUtils.writeData(SettingActivity.this, BatteryConstants.CHARGE_SAVER_SWITCH, true);
                    }
                ...
                case R.id.setting_power_fl:
                    //权限中心
                    Intent intentp = new Intent(SettingActivity.this, VacPrevance.class);
                ...
                case R.id.setting_rote_fl:
                    ...
                    ShareVac.rate(context);
                    break;
                case R.id.setting_family:
                    //family    https://play.google.com/store/search?q=CLEANMOBI&c=apps
                    Tools.openPlayStore(SettingActivity.this, getPackageName(), "https://play.google.com/store/apps/developer?id=VectorApps_Team");
                    break;
                case R.id.help_sug:
                    //联系我们
                    sendEmail("iebuznel@gmail.com", SettingActivity.this);
                    break;
                case R.id.setting_follow:
                    //关注我们
                    Intent intentfb = newFacebookIntent(SettingActivity.this.getPackageManager(), "https://www.facebook.com/Applock_VectorApps-832626453583360/");
    ...
    public void showFrequencyDialog(final Context c) {
        ...
        try {
            resetPattern.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    sp.edit().putInt(VacPref.PREF_BRIEF_SLOT, 0).apply();
            ...
            resetPassword.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    sp.edit().putInt(VacPref.PREF_BRIEF_SLOT, 2).apply();
            ...
            five_time.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    d.dismiss();
                    sp.edit().putInt(VacPref.PREF_BRIEF_SLOT, 1).apply();
        ...
        try {
            resetPattern.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(c, VacSetPattern.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra("set", VacSetPattern.SET_GRAPH_PASSWD);
            ...
            resetPassword.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(c, VacSetPattern.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra("set", VacSetPattern.SET_NORMAL_PASSWD);
                    c.startActivity(intent);
