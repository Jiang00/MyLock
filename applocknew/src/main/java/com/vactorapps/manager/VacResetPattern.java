 ...
 */
public class VacResetPattern extends BaseAbsActivity {
                    ...
                    public void run(AccountManagerFuture<Bundle> future) {
                        try {
                            ...
                            if (future.getResult().getBoolean(AccountManager.KEY_BOOLEAN_RESULT)) {
                                context.startActivity(new Intent(context, VacSetPattern.class).putExtra("set", VacSetPattern.SET_GRAPH_PASSWD));
                                context.finish();
                            } else {
                                MessageBox.Data data = new MessageBox.Data();
