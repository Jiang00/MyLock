...
public class VacMenu {
    ...
    public static void attach(final SlideMenu menu, final View reddot) {
        ...
        VacPref.pressMenu(VacMenu.MENU_LOCK_APP);
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.side_applcok:
                    ...
                    context.startActivity(new Intent(context, MainActivityAppLock.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS));
