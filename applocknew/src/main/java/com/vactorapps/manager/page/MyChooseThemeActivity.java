 ...
 */
public class MyChooseThemeActivity extends AppCompatActivity {


    RelativeLayout defaultTheme;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        defaultTheme = (RelativeLayout) this.findViewById(R.id.default_theme);
