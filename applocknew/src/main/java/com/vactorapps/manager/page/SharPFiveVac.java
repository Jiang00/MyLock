...
public class SharPFiveVac {

    private Context context;


    public SharPFiveVac(Context context) {
        super();
    ...
    public void setFiveRate2(boolean value) {
        SharedPreferences preferences = context.getSharedPreferences("five_", Context.MODE_PRIVATE);
        Editor editor = preferences.edit();
        editor.putBoolean("five_rate2", value);
        editor.commit();
    }

    public boolean getFiveRate2() {
        SharedPreferences preferences = context.getSharedPreferences("five_", Context.MODE_PRIVATE);
        boolean name = preferences.getBoolean("five_rate2", false);
        return name;
    }
