 ...
 */
public abstract class ClientActivitySecurity extends BaseAbsActivity implements ServiceConnection {
    ...
    protected void onStart() {
        super.onStart();
        try {
            if (!bindService(new Intent(this, WorksService.class), this, 0)){
