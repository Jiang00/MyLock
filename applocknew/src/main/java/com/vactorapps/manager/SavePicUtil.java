...
public class SavePicUtil {
    ...
    public static Drawable idToDrawable(int id) {
        return MyApp.getContext().getResources().getDrawable(R.drawable.theme_preview_two);
    }
...
//                + context.getPackageManager().getPackageInfo(MyApp.getContext().getPackageName(), 0).versionCode + "/" + "applock_theme_preview", name);
...
//    }
    public static void saveMyBitmap(String bitName, Bitmap mBitmap) throws PackageManager.NameNotFoundException {
        File f = new File(Environment.getExternalStorageDirectory()
                ...
                + MyApp.getContext().getPackageManager().getPackageInfo(
                MyApp.getContext().getPackageName(), 0).versionCode + "/" + "applock_theme_preview" + bitName);
