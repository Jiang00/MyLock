...
import com.vactorappsapi.manager.lib.io.BaseColumns;
 ...
 */
public class ProfileHelperVac extends SQLiteOpenHelper {
    public static final int VERSION = 1;
    public static final String NAME = "_PROFILES_";
    private static ProfileHelperVac helper;

    public static synchronized ProfileHelperVac singleton(Context context){
        if (helper == null){
            helper = new ProfileHelperVac(context.getApplicationContext(), NAME, null, VERSION);
            helper.getWritableDatabase();
        }
        return helper;
    }

    public ProfileHelperVac(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    public ProfileHelperVac(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
